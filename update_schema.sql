...
ALTER TABLE games ADD COLUMN points_per_square INTEGER NOT NULL DEFAULT 1;
ALTER TABLE games ADD COLUMN points_per_bingo INTEGER NOT NULL DEFAULT 2;
ALTER TABLE games ADD COLUMN points_per_unique INTEGER NOT NULL DEFAULT 2;


ALTER TABLE games ADD COLUMN game_rules TEXT;